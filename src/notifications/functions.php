...
function notify_trainer(int $rat_id, string $title, string $message, string $source = "system", ?DateTime $valid_till = null)
{
    __notify_user("trainer", $rat_id, $title, $message, $source, $valid_till);
}
