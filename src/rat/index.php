...
<main>
    ...
    <div class="grid">
        ...
        <div class="grid-line">
                ...
                <div class="traffic <?= $traffic['status'] ?>">
                    ...
                    <?php else: ?>
                        <svg width="30" height="30" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.8333 23.3333H2.33334" stroke="#22C55E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.8333 5.32236V24.1722C12.8334 24.3494 12.8738 24.5243 12.9515 24.6835C13.0293 24.8428 13.1422 24.9823 13.2819 25.0913C13.4216 25.2004 13.5842 25.2762 13.7576 25.3131C13.9309 25.3499 14.1104 25.3467 14.2823 25.3039L22.1667 23.3334V6.48903C22.1666 5.9687 21.9926 5.46334 21.6724 5.05325C21.3521 4.64315 20.904 4.35187 20.3992 4.22569L15.7325 3.05903C15.3886 2.97307 15.0297 2.96659 14.6829 3.04007C14.3362 3.11356 14.0107 3.26508 13.7313 3.48313C13.4518 3.70118 13.2257 3.98003 13.0701 4.29851C12.9146 4.61699 12.8336 4.9679 12.8333 5.32236Z" stroke="#22C55E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.8333 4.66669H9.33333C8.71449 4.66669 8.121 4.91252 7.68342 5.3501C7.24583 5.78769 7 6.38118 7 7.00002V23.3334" stroke="#22C55E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.3333 14H16.345" stroke="#22C55E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M25.6667 23.3333H22.1667" stroke="#22C55E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
            ...
            <a href="/rat/progress/logs" class="grid-tile">
                <div class="top">
                    <h2>My Progess</h2>
                </div>
                ...
                <?php else: ?>
                    <p class="bottom-text">
                        You don't have a trainer yet. Please contact the gym admin to assign a trainer for you.
                    </p>
                <?php endif; ?>
        ...
        <a href="/rat/support/index.php" class="grid-tile">
            <div class="top">
                <h2>Contact<br />
                    Support</h2>
            </div>
