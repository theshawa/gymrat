                ...
                <div class="traffic <?= $traffic['status'] ?>">
                    ...
                    <?php else: ?>
                        <svg width="30" height="30" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.8333 23.3333H2.33334" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <path d="M12.8333 4.66669H9.33333C8.71449 4.66669 8.121 4.91252 7.68342 5.3501C7.24583 5.78769 7 6.38118 7 7.00002V23.3334" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.3333 14H16.345" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M25.6667 23.3333H22.1667" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="progress <?= $progress['status'] ?>">
                        <?php if ($progress['status'] === "well_done"): ?>
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M17.5 16.3333C16.7959 15.805 15.9814 15.4428 15.1174 15.274C14.2534 15.1052 13.3625 15.1341 12.5113 15.3586C11.6601 15.5831 10.8707 15.9973 10.2024 16.5702C9.53401 17.1431 9.00399 17.8598 8.65201 18.6667" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.6247 7.96249C9.35551 9.30649 11.0833 15.1667 9.33334 17.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        <?php else: ?>
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.8 16.8L11.2 11.2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <path d="M25.0833 25.0833L23.45 23.45" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M4.54999 4.54999L2.91666 2.91666" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
