...
$report_description = (($get_plan) ? $membership_titles[$get_plan] : "All") . " membership plan purchases for " .  date("F", mktime(0, 0, 0, $get_month, 10)) . ", " .  $get_year;
    ...
    <div class="staff-base-container">
        ...
        <div style="margin: 30px 10px; display: grid; grid-template-columns: 3fr 1fr; gap: 20px;">
            ...
            target="_blank" style="display: flex; gap: 10px; align-items: center; justify-self: end;">
                <input type="hidden" name="report_title" value="Monthly Membership Plan Sales Report">
