...
$pageConfig = [
    ...
    "scripts" => ["/staff/scripts/forms.js"]
];
...
<main>
    <div style="display: flex; flex-direction: column; align-content: center; justify-content: center; width: 100%">
        <form action="email_verification_process.php" method="post" class="staff-card-container">
            <div style="margin: 50px 0px; display: flex; flex-direction: column; align-items: center;">
                ...
                <h3 style="margin-top: 10px;">Verify Email</h3>
            </div>
            <input required type="text" placeholder="Enter code" name="code" class="staff-input-primary staff-input-base">
            <button class="staff-button secondary" style="margin: 10px 0; padding: 20px;">Verify Code</button>
            <!-- <a href="/staff/login/index.php" style="margin: 20px; align-self: center"> Back to Login</a>  -->
            <a href="resend_process.php" style="margin: 20px; align-self: center">Resend code</a> 
        </form>
    </div>
</main>
