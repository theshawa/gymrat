...
<main>
    <div style="display: flex; flex-direction: column; align-content: center; justify-content: center; width: 100%">
        <form action="forgot_password_process.php" method="post" class="staff-card-container">
            <div style="margin: 50px 0px; display: flex; flex-direction: column; align-items: center;">
                ...
                <h3 style="margin-top: 10px;">Forgot Password</h3>
            </div>
            <input type="email" required placeholder="Email" name="email" class="staff-input-primary staff-input-base">
            <button class="staff-button secondary" style="margin: 10px 0; padding: 20px;">Verify Email</button>
