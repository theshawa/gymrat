...
<main style="padding: 0;">
    ...
    <!-- if windows size is big enough -->
    <div class="large-window" style="display: grid; grid-template-rows: 1fr; grid-template-columns: 1fr 1fr; width: 100%">
        <div style="background-image: url('../../uploads/default-images/staff-login.jpg'); background-size: cover; background-position: center; height: 100%; width: 100%;
        display: grid; grid-template-rows: 1fr 1fr; grid-template-columns: 1fr 1fr; align-items: center; justify-items: center;">
            <!-- <img src="../../uploads/default-images/staff-login.jpg" alt="" style="width: 100%; height: 100%; object-fit: cover;"> -->
             <div style="grid-row: 1; grid-column: 1; align-self: start; justify-self: start; padding: 40px;">
                <svg width="150" viewBox="0 0 94 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="fill: white;">
                    <path
        ...
        <div style="display: flex; flex-direction: column; align-content: center; justify-content: center; width: 100%; height: 100%; background-color: white;">
            <form action="login_process.php" method="post" style="display: flex; flex-direction: column; width: 100%; 
            max-width: 400px; height: 100%; max-height: 500px; background-color: white; padding: 40px; border-radius: 20px;
            align-self: center; justify-content: center;">
                <div style="margin: 20px 0px; display: flex; flex-direction: column; align-items: center;">
                    <h1 style="margin: 5px; font-weight: 900;">STAFF LOGIN</h1>
                </div>
    ...
    <!-- If window size is smaller -->
    <div class="small-window" style="display: flex; flex-direction: column; align-content: center; justify-content: center; width: 100%">
        <form action="login_process.php" method="post" class="staff-card-container">
            <div style="margin: 50px 0px; display: flex; flex-direction: column; align-items: center;">
                ...
                <h4 style="margin: 5px;">STAFF LOGIN</h4>
            </div>
            <input type="email" required placeholder="Email" name="email" class="staff-input-primary staff-input-base">
            <input type="password" required placeholder="Password" name="password" class="staff-input-primary staff-input-base">
            <button class="staff-button secondary" style="margin: 10px 0; padding: 20px;">Login</button>
