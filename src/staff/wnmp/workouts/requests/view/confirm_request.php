...
try {
    ...
    redirect_with_error_alert("Failed to confirm workout request due to an error: " . $e->getMessage(), "/staff/wnmp/workouts/requests");
}
...
try {
    ...
    redirect_with_info_alert("Confirmation successful, but failed to send notification: " . $th->getMessage(), "/staff/wnmp/workouts/requests");
}


redirect_with_success_alert("Workout request confirmed successfully", "/staff/wnmp/workouts/requests");
?>
