...
<div class="navbar">
    <a href="/trainer/index.php" class="<?php echo $active === 1 ? 'active' : '' ?>">
    ...
    <a href="/trainer/notifications/index.php" class="<?php echo $active === 2 ? 'active' : '' ?>">
    ...
    <a href="/trainer/profile/index.php" class="<?php echo $active === 3 ? 'active' : '' ?>">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
