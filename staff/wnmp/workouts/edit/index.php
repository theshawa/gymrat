            ...
            <div style="padding: 0px 10px;">
                ...
                <div>
                    ...
                    <?php foreach ($workout["exercise"] as $exercise): ?>
                        <form action="edit_current_exercises.php" method="post" class="edit-workout-row">
                            ...
                            <button type="submit" class="edit-workout-input-delete" name="updateExercise">Update</button>
                            <input type="hidden" name="workout_id" value="<?= $workout['id'] ?>">
                        </form>
                    <?php endforeach; ?>
                    <form action="edit_current_exercises.php" method="post">
